...
export default {
  ...
  "ui.modelScale": "Escala:",
  "ui.modelScaleTitle": "Escala del modelo (%)",
  "ui.uniformScaleOn": "Escala uniforme (bloqueada)",
  "ui.uniformScaleOff": "Escala no uniforme (desbloqueada)",
  "ui.scaleReset": "Restablecer al 100%",
  "ui.fitCamera": "Ajustar cámara al modelo",
  "ui.presetModels": "Modelos predefinidos",
  "ui.presetCube": "Cubo",
  "ui.presetCylinder": "Cilindro",
  "ui.presetBowl": "Cuenco",
  "ui.modeStandard": "Estándar",
  "ui.modeAutoFit": "Ajuste automático (Imagen)",
  "ui.shapeNgon": "n-ágono",
  "ui.autofitHeight": "Altura (mm)",
  "ui.autofitRepeat": "Cantidad de paneles",
  "ui.autofitSides": "Lados (n ≧ 3)",
  "ui.uploadShort": "Subir",
  "ui.autofitStats": "Circunferencia: {c} mm · Diámetro: {d} mm · Cara: {w} mm",
  ...
  "license.item3": "Los detalles sobre el método de capas intercaladas («振り重ね») están documentados en este <a href=\"https://note.com/mithril_mex/n/nf6866893448c\" target=\"_blank\" rel=\"noopener\">artículo de note</a>.<br>Las propinas y el apoyo son bienvenidos.",
  ...
  "license.item5": "<strong>No se proporciona soporte</strong>. El autor no tiene obligación de corregir errores, responder preguntas ni actualizar esta herramienta.",
  ...
  "license.item8": "Código fuente disponible en <a href=\"https://github.com/Mithril-3d/BumpMesh_Color\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  "imprint.btn": "Política de privacidad",
  "imprint.title": "Política de privacidad",
  "imprint.privacyMeshLocal": "Todos los modelos 3D (STL, OBJ, 3MF, STEP) y texturas se procesan localmente en su navegador. Ningún modelo ni imagen se envía a servidores externos.",
  "imprint.privacyHosting": "Este sitio web está alojado en <strong>GitHub Pages</strong> (GitHub Inc. / Microsoft Corp., 88 Colin P Kelly Jr St, San Francisco, CA 94107, EE. UU.). Al visitar este sitio, GitHub puede procesar su dirección IP en registros de servidor estándar. Consulte la <a href=\"https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement\" target=\"_blank\" rel=\"noopener\">Declaración de privacidad de GitHub</a>.",
  "storage.modeLabel": "Guardado autom.:",
  "storage.session": "Sesión",
  "storage.local": "Persistente",
  "storage.sessionDesc": "Conservar ajustes hasta cerrar la pestaña (sessionStorage)",
  "storage.localDesc": "Conservar ajustes permanentemente en el navegador (localStorage)",
  "imprint.privacyLocal": "Esta herramienta almacena la configuración de usuario (idioma, tema, textura, mapeo y opciones de interfaz) en <strong>sessionStorage</strong> o <strong>localStorage</strong> de su navegador según su elección. Estos datos permanecen estrictamente en su navegador, nunca se transmiten a servidores externos y no se utilizan para cookies o seguimiento.",
  ...
  "color.sectionTitle": "Color y multiherramienta",
  "color.enabled": "Habilitado",
  "color.tabQuantize": "Cuantización de color",
  "color.tabLayerBlend": "Capas intercaladas",
  "color.show3DPreview": "Mostrar colores en vista previa 3D",
  "color.untexturedTool": "Herramienta sin textura",
  "color.untexturedToolTitle": "Herramienta asignada a áreas enmascaradas o caras sin textura (base, etc.)",
  "color.extruderCount": "Extrusores (Colores)",
  "color.extruderCountTitle": "Número de colores dominantes a extraer (cantidad de extrusores)",
  "color.assignLabel": "Herr.:",
  "color.interleavedDesc": "Alterna capas para cada color cuantizado; extruye relieves en el color objetivo y hendiduras en otros colores.",
  "color.layerThickness": "Altura de capa (mm)",
  "color.layerThicknessTitle": "Altura de capa por herramienta (coincidir con el laminador)",
  "color.convexAmp": "Relieve convexo (mm)",
  "color.convexAmpTitle": "Altura de extrusión para capas coincidentes con el color",
  "color.concaveAmp": "Hendidura cóncava (mm)",
  "color.concaveAmpTitle": "Profundidad de hendidura para capas no coincidentes con el color",
  "color.profileMode": "Perfil de capa",
  "color.profileModeTitle": "Geometría de sección por capa. El escalón plano crea bordes limpios (estándar / recomendado).",
  "color.profileStep": "Escalón plano (Estándar / Recomendado)",
  "color.profileLouver": "Voladizo de lamas 45° (Blindaje de color / Experimental)",
  "color.shadingMode": "Modo de sombreado",
  "color.shadingModeTitle": "Mapeo tonal. Nítido ofrece niveles binarios; Gradiente modula la altura según la luminosidad.",
  "color.shadingSharp": "Nítido (Binario / 0-1)",
  "color.shadingGradient": "Gradiente (Continuo)",
  "color.interleavedTools": "Herramientas intercaladas",
  "color.interleavedStructure": "🔄 Estructura de laminado intercalado",
  "color.infoPitch": "• Altura de capa: {pitch} mm (Capas totales: ~{layers})",
  "color.infoConvex": "• Relieve convexo: +{val} mm (color coincidente)",
  "color.infoConcave": "• Hendidura cóncava: -{val} mm (no coincidente)",
  "color.infoProfile": "• Perfil: {profile}",
  "color.infoShading": "• Sombreado: {shading}",
  "color.infoPattern": "• Patrón: {pattern} → …",
  "color.exportBtn": "🎨 Exportar 3MF multiherramienta",
  "color.exportBtnTitle": "Exportar archivo 3MF multiherramienta compatible con PrusaSlicer, OrcaSlicer y Bambu Studio",
  "color.interleavedPreviewMap": "🖼️ Ver mapa de modulación intercalada (2D)",
  "color.mapModalTitle": "🖼️ Vista previa del mapa de modulación intercalada (Pesos de mezcla)",
  "color.mapModalModeLabel": "Modo de visualización:",
  "color.mapModalModeCurrent": "① Recorte de centroide K-means",
  "color.mapModalModeFullrange": "② Preservación tonal (Luminancia de rango completo / Sombras preservadas)",
  "color.mapModalModeOriginal": "③ Imagen de textura original",
  "color.mapModalGamma": "Gamma tonal:",
  "color.mapModalLegend": "* Blanco (1.0) = Herramienta 1 saliente máx / Negro (0.0) = Herramienta 2 saliente máx / Gris medio (0.5) = Exposición igual",
  "color.mapModalSavePng": "💾 Guardar imagen PNG",
  "color.mapModalClose": "Cerrar",
