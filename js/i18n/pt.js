...
export default {
  ...
  "ui.modelScaleTitle": "Escala do modelo (%)",
  "ui.uniformScaleOn": "Escala uniforme (bloqueada)",
  "ui.uniformScaleOff": "Escala não uniforme (desbloqueada)",
  "ui.scaleReset": "Redefinir para 100%",
  "ui.fitCamera": "Ajustar câmera ao modelo",
  "ui.presetModels": "Modelos predefinidos",
  "ui.presetCube": "Cubo",
  "ui.presetCylinder": "Cilindro",
  "ui.presetBowl": "Tigela",
  "ui.modeStandard": "Padrão",
  "ui.modeAutoFit": "Ajuste automático (Imagem)",
  "ui.shapeNgon": "Prisma n-gonal",
  "ui.autofitHeight": "Altura (mm)",
  "ui.autofitRepeat": "Contagem de painéis",
  "ui.autofitSides": "Lados (n ≧ 3)",
  "ui.uploadShort": "Carregar",
  "ui.autofitStats": "Circunferência: {c} mm · Diâmetro: {d} mm · Face: {w} mm",
  ...
  "license.item3": "Os detalhes sobre o método de camadas intercaladas («振り重ね») estão documentados no <a href=\"https://note.com/mithril_mex/n/nf6866893448c\" target=\"_blank\" rel=\"noopener\">note</a>.<br>Gorjetas e apoio são bem-vindos.",
  ...
  "license.item5": "<strong>Nenhum suporte</strong> é fornecido. O autor não tem obrigação de corrigir bugs, responder perguntas ou atualizar esta ferramenta.",
  ...
  "license.item8": "Código-fonte disponível no <a href=\"https://github.com/Mithril-3d/BumpMesh_Color\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  "imprint.btn": "Política de Privacidade",
  "imprint.title": "Política de Privacidade",
  "imprint.privacyMeshLocal": "Todos os modelos 3D (STL, OBJ, 3MF, STEP) e texturas são processados totalmente no seu navegador (localmente). Nenhum arquivo ou modelo é enviado para servidores externos.",
  "imprint.privacyHosting": "Este site está hospedado no <strong>GitHub Pages</strong> (GitHub Inc. / Microsoft Corp., 88 Colin P Kelly Jr St, San Francisco, CA 94107, EUA). Ao visitar este site, o GitHub pode processar seu endereço IP nos logs padrão do servidor. Consulte a <a href=\"https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement\" target=\"_blank\" rel=\"noopener\">Declaração de Privacidade do GitHub</a>.",
  "storage.modeLabel": "Salvar auto:",
  "storage.session": "Sessão",
  "storage.local": "Persistente",
  "storage.sessionDesc": "Manter configurações até fechar a aba (sessionStorage)",
  "storage.localDesc": "Manter configurações permanentemente no navegador (localStorage)",
  "imprint.privacyLocal": "Esta ferramenta armazena as configurações do usuário (idioma, tema, textura, mapeamento e opções de interface) no <strong>sessionStorage</strong> ou <strong>localStorage</strong> do seu navegador, de acordo com sua escolha. Esses dados permanecem exclusivamente no seu navegador, nunca são transmitidos a servidores externos e não são usados para cookies ou rastreamento.",
  ...
  "color.sectionTitle": "Cor e multiferramenta",
  "color.enabled": "Ativado",
  "color.tabQuantize": "Quantização de cor",
  "color.tabLayerBlend": "Camadas intercaladas",
  "color.show3DPreview": "Exibir cores na pré-visualização 3D",
  "color.untexturedTool": "Ferramenta sem textura",
  "color.untexturedToolTitle": "Ferramenta atribuída a áreas mascaradas ou faces sem textura (base, etc.)",
  "color.extruderCount": "Extrusoras (Cores)",
  "color.extruderCountTitle": "Número de cores dominantes a extrair (contagem de extrusoras)",
  "color.assignLabel": "Ferr.:",
  "color.interleavedDesc": "Alterna camadas para cada cor quantizada; cria relevo na cor de destino e rebaixo nas demais.",
  "color.layerThickness": "Espessura da camada (mm)",
  "color.layerThicknessTitle": "Altura da camada por ferramenta (alinhar ao fatiador)",
  "color.convexAmp": "Relevo convexo (mm)",
  "color.convexAmpTitle": "Altura de extrusão para camadas que correspondem à cor",
  "color.concaveAmp": "Rebaixo côncavo (mm)",
  "color.concaveAmpTitle": "Profundidade de rebaixo para camadas não coincidentes",
  "color.profileMode": "Perfil da camada",
  "color.profileModeTitle": "Geometria da seção por camada. Degrau plano cria bordas limpas (padrão / recomendado).",
  "color.profileStep": "Degrau plano (Padrão / Recomendado)",
  "color.profileLouver": "Aba veneziana 45° (Blindagem de cor / Experimental)",
  "color.shadingMode": "Modo de sombreamento",
  "color.shadingModeTitle": "Mapeamento tonal. Nítido oferece níveis binários; Gradiente modula a altura conforme o brilho.",
  "color.shadingSharp": "Nítido (Binário / 0-1)",
  "color.shadingGradient": "Gradiente (Contínuo)",
  "color.interleavedTools": "Ferramentas intercaladas",
  "color.interleavedStructure": "🔄 Estrutura de fatiamento intercalada",
  "color.infoPitch": "• Altura da camada: {pitch} mm (Camadas totais: ~{layers})",
  "color.infoConvex": "• Relevo convexo: +{val} mm (cor correspondente)",
  "color.infoConcave": "• Rebaixo côncavo: -{val} mm (não correspondente)",
  "color.infoProfile": "• Perfil: {profile}",
  "color.infoShading": "• Sombreamento: {shading}",
  "color.infoPattern": "• Padrão: {pattern} → …",
  "color.exportBtn": "🎨 Exportar 3MF multiferramenta",
  "color.exportBtnTitle": "Exportar arquivo 3MF multiferramenta compatível com PrusaSlicer, OrcaSlicer e Bambu Studio",
  "color.interleavedPreviewMap": "🖼️ Ver mapa de modulação intercalada (2D)",
  "color.mapModalTitle": "🖼️ Pré-visualização do mapa de modulação intercalada",
  "color.mapModalModeLabel": "Modo de exibição:",
  "color.mapModalModeCurrent": "① Corte do centróide K-means",
  "color.mapModalModeFullrange": "② Preservação tonal (Luminância total / Sombras preservadas)",
  "color.mapModalModeOriginal": "③ Imagem de textura original",
  "color.mapModalGamma": "Gama tonal:",
  "color.mapModalLegend": "* Branco (1.0) = Ferramenta 1 saliência máx / Preto (0.0) = Ferramenta 2 saliência máx / Cinza médio (0.5) = Exposição igual",
  "color.mapModalSavePng": "💾 Salvar imagem PNG",
  "color.mapModalClose": "Fechar",
