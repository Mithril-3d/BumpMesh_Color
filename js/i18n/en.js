...
export default {
  ...
  "ui.modelScale": "Scale:",
  "ui.modelScaleTitle": "Model scale (%)",
  "ui.uniformScaleOn": "Uniform scaling (locked)",
  "ui.uniformScaleOff": "Non-uniform scaling (unlocked)",
  "ui.scaleReset": "Reset scale to 100%",
  "ui.fitCamera": "Fit camera to model",
  "ui.presetModels": "Preset Models",
  "ui.presetCube": "Cube",
  "ui.presetCylinder": "Cylinder",
  "ui.presetBowl": "Bowl",
  "ui.modeStandard": "Standard",
  "ui.modeAutoFit": "Auto-fit (Image)",
  "ui.shapeNgon": "n-gon",
  "ui.autofitHeight": "Height (mm)",
  "ui.autofitRepeat": "Panel Count",
  "ui.autofitSides": "Sides (n ≧ 3)",
  "ui.uploadShort": "Upload",
  "ui.autofitStats": "Circumference: {c} mm · Dia: {d} mm · Face: {w} mm",
  ...
  "license.item8": "Source code available on <a href=\"https://github.com/Mithril-3d/BumpMesh_Color\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  "imprint.btn": "Privacy Policy",
  ...
  "storage.modeLabel": "Auto-save:",
  "storage.session": "Session",
  "storage.local": "Persistent",
  "storage.sessionDesc": "Keep settings until tab closes (sessionStorage)",
  "storage.localDesc": "Keep settings permanently in browser (localStorage)",
  "imprint.privacyLocal": "This tool stores user settings (language, theme, texture, mapping, and UI options) in your browser&rsquo;s <strong>sessionStorage</strong> or <strong>localStorage</strong> depending on your choice. This data is kept strictly inside your browser, is never transmitted to any external server, and is not used for cookies or user tracking.",
  ...
  "color.sectionTitle": "Color & Multi-Tool",
  "color.enabled": "Enabled",
  "color.tabQuantize": "Color Quantization",
  "color.tabLayerBlend": "Interleaved Layers",
  "color.show3DPreview": "Show colors in 3D preview",
  "color.untexturedTool": "Untextured Tool",
  "color.untexturedToolTitle": "Tool assigned to masked areas or untextured faces (bottom, etc.)",
  "color.extruderCount": "Extruders (Colors)",
  "color.extruderCountTitle": "Number of dominant colors to extract (Extruder count)",
  "color.assignLabel": "Tool:",
  "color.interleavedDesc": "Alternates layers for each quantized color tool; extrudes convex features on matching colors and indents on non-matching colors.",
  "color.layerThickness": "Layer Thickness (mm)",
  "color.layerThicknessTitle": "Layer height per tool (match your slicer layer height)",
  "color.convexAmp": "Convex Offset (mm)",
  ...
  "color.shadingMode": "Shading Mode",
  ...
  "color.infoConvex": "• Convex offset: +{val} mm (matching target color)",
  "color.infoConcave": "• Concave recess: -{val} mm (non-matching)",
  "color.infoProfile": "• Profile: {profile}",
  "color.infoShading": "• Shading: {shading}",
  "color.infoPattern": "• Alternating pattern: {pattern} → …",
  "color.exportBtn": "🎨 Export Multi-Tool 3MF",
  "color.exportBtnTitle": "Export Multi-Tool 3MF fully compatible with PrusaSlicer, OrcaSlicer, and Bambu Studio",
  "color.interleavedPreviewMap": "🖼️ View Interleaved Modulation Map (2D)",
  "color.mapModalTitle": "🖼️ Interleaved Modulation Map (Blend Weight) Preview",
  "color.mapModalModeLabel": "Display Mode:",
  "color.mapModalModeCurrent": "① K-means Centroid Clipping",
  "color.mapModalModeFullrange": "② Tone-Preserving (Full-Range Luminance / Shadow Preserved)",
  "color.mapModalModeOriginal": "③ Original Texture Image",
  "color.mapModalGamma": "Tonal Gamma:",
  "color.mapModalLegend": "* White (1.0) = Tool 1 Max Protrusion / Black (0.0) = Tool 2 Max Protrusion / Mid-Gray (0.5) = Equal Exposure",
  "color.mapModalSavePng": "💾 Save PNG Image",
  "color.mapModalClose": "Close",
