...
export default {
  ...
  "ui.modelScale": "倍率:",
  "ui.modelScaleTitle": "モデル倍率 (%)",
  "ui.uniformScaleOn": "縦横比固定 (均等拡大縮小)",
  "ui.uniformScaleOff": "軸個別調整 (縦横比自由)",
  "ui.scaleReset": "100%にリセット",
  "ui.fitCamera": "全体表示 (カメラフィット)",
  "ui.presetModels": "プリセットモデル",
  "ui.presetCube": "立方体",
  "ui.presetCylinder": "円柱",
  "ui.presetBowl": "お椀",
  "ui.modeStandard": "通常",
  "ui.modeAutoFit": "自動調整 (画像連動)",
  "ui.shapeNgon": "n角形柱",
  "ui.autofitHeight": "高さ (mm)",
  "ui.autofitRepeat": "一周の枚数",
  "ui.autofitSides": "角数 (n ≧ 3)",
  "ui.uploadShort": "ファイル",
  "ui.autofitStats": "外周: {c} mm · 直径: {d} mm · 1面幅: {w} mm",
  "ui.loadStl": "モデルを読み込む…",
  ...
  "license.item3": "振り重ねについてはこちらの<a href=\"https://note.com/mithril_mex/n/nf6866893448c\" target=\"_blank\" rel=\"noopener\">note</a>で詳細を記載しています。<br>チップで支援も可能です。",
  "license.item4": "このツールは<strong>現状のまま</strong>提供され、いかなる種類の<strong>保証もありません</strong>。自己責任でご利用ください。",
  "license.item5": "<strong>サポートは提供されません</strong>。作者にはバグの修正、質問への回答、ツールの更新の義務はありません。",
  "license.item6": "作者は、このツールの使用に起因する<strong>損害</strong>、データ損失、またはその他の問題について責任を負いません。",
  "license.item8": "ソースコードは <a href=\"https://github.com/Mithril-3d/BumpMesh_Color\" target=\"_blank\" rel=\"noopener\">GitHub</a> で公開されています。",
  "imprint.btn": "プライバシーポリシー",
  "imprint.title": "プライバシーポリシー",
  "imprint.privacyMeshLocal": "読み込んだ3Dモデル（STL, OBJ, 3MF, STEP）やテクスチャ画像はすべてお使いのブラウザ内（ローカル）で処理されます。データが外部サーバーに送信されることは一切ありません。",
  "storage.modeLabel": "自動保存:",
  "storage.session": "短期保存",
  "storage.local": "長期保存",
  "storage.sessionDesc": "タブを閉じるまで設定を保持 (sessionStorage)",
  "storage.localDesc": "ブラウザを終了しても設定を保持 (localStorage)",
  "imprint.privacyLocal": "このツールは、ユーザーの選択に応じてブラウザの<strong>sessionStorage</strong>または<strong>localStorage</strong>に設定（言語、テーマ、テクスチャ設定、マッピング設定、各種UI設定など）を保存します。保存されたデータはユーザーの端末内にのみ保持され、外部サーバーへ送信されることはありません。また、Cookieや利用者追跡のための保存ではありません。",
  ...
  "color.enabled": "有効",
  "color.tabQuantize": "カラー量子化",
  "color.tabLayerBlend": "交互積層 (振り重ね)",
  "color.show3DPreview": "3Dプレビューで色を表示",
  "color.untexturedTool": "非テクスチャ部ツール",
  "color.untexturedToolTitle": "マスク領域やテクスチャを適用しない面（底面など）に割り当てるツール",
  "color.extruderCount": "Extruder数 (色数)",
  "color.extruderCountTitle": "減色する代表色の数（Extruder数）",
  "color.assignLabel": "割当:",
  "color.interleavedDesc": "カラー量子化の各ツールを一定厚みで交互に積層し、目的色の領域で凸、非目的色の領域で凹を生成します。",
  "color.layerThickness": "積層厚み (mm)",
  "color.layerThicknessTitle": "各ツールの1層あたりの厚み（スライサーの積層ピッチに合わせます）",
  "color.convexAmp": "凸量 / 突出 (mm)",
  ...
  "color.infoConvex": "• 凸突出量: +{val} mm (目的色と一致)",
  "color.infoConcave": "• 凹引込量: -{val} mm (目的色と不一致)",
  "color.infoProfile": "• 断面プロファイル: {profile}",
  "color.infoShading": "• 階調表現: {shading}",
  "color.infoPattern": "• 交互パターン: {pattern} → …",
  "color.exportBtn": "🎨 Export Multi-Tool 3MF",
  "color.exportBtnTitle": "PrusaSlicer, OrcaSlicer, Bambu Studio 完全互換のマルチツール 3MF をエクスポート",
  "color.interleavedPreviewMap": "🖼️ 振り重ね変調画像（2Dマップ）を確認",
  "color.mapModalTitle": "🖼️ 振り重ね変調画像（ブレンド重みマップ）プレビュー",
  "color.mapModalModeLabel": "表示モード:",
  "color.mapModalModeCurrent": "① K-means重心クリッピング",
  "color.mapModalModeFullrange": "② 階調保持（フルレンジ輝度 / 暗部保持）",
  "color.mapModalModeOriginal": "③ 元テクスチャ画像",
  "color.mapModalGamma": "階調ガンマ:",
  "color.mapModalLegend": "※ 白 (1.0) = Tool 1 最大突出 / 黒 (0.0) = Tool 2 最大突出 / 中間グレー (0.5) = 等幅露出",
  "color.mapModalSavePng": "💾 この画像をPNG保存",
  "color.mapModalClose": "閉じる",
