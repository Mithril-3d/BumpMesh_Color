...
export default {
  ...
  "ui.modelScale": "Scala:",
  "ui.modelScaleTitle": "Scala modello (%)",
  "ui.uniformScaleOn": "Scala uniforme (bloccata)",
  "ui.uniformScaleOff": "Scala non uniforme (sbloccata)",
  "ui.scaleReset": "Ripristina al 100%",
  "ui.fitCamera": "Adatta vista al modello",
  "ui.presetModels": "Modelli predefiniti",
  "ui.presetCube": "Cubo",
  "ui.presetCylinder": "Cilindro",
  "ui.presetBowl": "Ciotola",
  "ui.modeStandard": "Standard",
  "ui.modeAutoFit": "Adattamento auto (Immagine)",
  "ui.shapeNgon": "Prisma n-gonale",
  "ui.autofitHeight": "Altezza (mm)",
  "ui.autofitRepeat": "Numero di pannelli",
  "ui.autofitSides": "Lati (n ≧ 3)",
  "ui.uploadShort": "Carica",
  "ui.autofitStats": "Circonferenza: {c} mm · Diametro: {d} mm · Faccia: {w} mm",
  ...
  "storage.modeLabel": "Salvataggio auto:",
  "storage.session": "Sessione",
  "storage.local": "Persistente",
  "storage.sessionDesc": "Mantieni le impostazioni fino alla chiusura della scheda (sessionStorage)",
  "storage.localDesc": "Mantieni le impostazioni in modo permanente nel browser (localStorage)",
  "imprint.privacyLocal": "Questo strumento memorizza le impostazioni utente (lingua, tema, texture, mappatura e opzioni UI) nel <strong>sessionStorage</strong> o <strong>localStorage</strong> del browser in base alla scelta. Questi dati rimangono esclusivamente nel browser, non vengono mai trasmessi a server esterni e non vengono utilizzati per cookie o tracciamento.",
  ...
  "color.interleavedPreviewMap": "🖼️ Visualizza mappa modulazione interleaved (2D)",
  "color.mapModalTitle": "🖼️ Anteprima mappa modulazione interleaved (Pesi miscela)",
  "color.mapModalModeLabel": "Modalità di visualizzazione:",
  "color.mapModalModeCurrent": "① Taglio del baricentro K-means",
  "color.mapModalModeFullrange": "② Conservazione tonale (Luminanza a gamma intera / Ombre preservate)",
  "color.mapModalModeOriginal": "③ Immagine texture originale",
  "color.mapModalGamma": "Gamma tonale:",
  "color.mapModalLegend": "* Bianco (1.0) = Utensile 1 sporgenza max / Nero (0.0) = Utensile 2 sporgenza max / Grigio medio (0.5) = Esposizione uguale",
  "color.mapModalSavePng": "💾 Salva immagine PNG",
  "color.mapModalClose": "Chiudi",
