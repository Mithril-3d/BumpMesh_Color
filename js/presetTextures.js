...
const IMAGE_PRESETS = [
  ...
  // Western Patterns
  { name: 'Houndstooth (2-Color)',     url: 'textures/houndstooth_2color.png',     thumb: 'textures/thumbs/houndstooth_2color.webp',     defaultScale: 0.5 },
  { name: 'Chevron (2-Color)',         url: 'textures/chevron_2color.png',         thumb: 'textures/thumbs/chevron_2color.webp',         defaultScale: 0.5 },
  { name: 'Herringbone (3-Color)',     url: 'textures/herringbone_3color.png',     thumb: 'textures/thumbs/herringbone_3color.webp',     defaultScale: 0.5 },
  { name: 'Argyle (3-Color)',          url: 'textures/argyle_3color.png',          thumb: 'textures/thumbs/argyle_3color.webp',          defaultScale: 0.5 },
  { name: 'Moroccan (4-Color)',        url: 'textures/moroccan_4color.png',        thumb: 'textures/thumbs/moroccan_4color.webp',        defaultScale: 0.5 },
  { name: 'Tartan (4-Color)',          url: 'textures/tartan_4color.png',          thumb: 'textures/thumbs/tartan_4color.webp',          defaultScale: 0.5 },
  { name: 'Stained Glass (8-Color)',   url: 'textures/stained_glass_8color.png',   thumb: 'textures/thumbs/stained_glass_8color.webp',   defaultScale: 0.5 },
  // Geometric Mosaics
  { name: 'Honeycomb (2-Color)',       url: 'textures/honeycomb_2color.png',       thumb: 'textures/thumbs/honeycomb_2color.webp',       defaultScale: 0.5 },
  { name: 'Triangle Mosaic (3-Color)', url: 'textures/triangle_mosaic_3color.png', thumb: 'textures/thumbs/triangle_mosaic_3color.webp', defaultScale: 0.5 },
  { name: 'Isometric Cubes (3-Color)', url: 'textures/isometric_cubes_3color.png', thumb: 'textures/thumbs/isometric_cubes_3color.webp', defaultScale: 0.5 },
  { name: 'Octagon Tile (4-Color)',    url: 'textures/octagon_square_4color.png',  thumb: 'textures/thumbs/octagon_square_4color.webp',  defaultScale: 0.5 },
  { name: 'Kaleidoscope (8-Color)',    url: 'textures/kaleidoscope_8color.png',    thumb: 'textures/thumbs/kaleidoscope_8color.webp',    defaultScale: 0.5 },
