...
export default {
  ...
  "ui.modelScale": "Skalierung:",
  "ui.modelScaleTitle": "Modellskalierung (%)",
  "ui.uniformScaleOn": "Gleichmäßige Skalierung (gesperrt)",
  "ui.uniformScaleOff": "Ungleichmäßige Skalierung (entsperrt)",
  "ui.scaleReset": "Auf 100% zurücksetzen",
  "ui.fitCamera": "Kamera an Modell anpassen",
  "ui.presetModels": "Vordefinierte Modelle",
  "ui.presetCube": "Würfel",
  "ui.presetCylinder": "Zylinder",
  "ui.presetBowl": "Schale",
  "ui.modeStandard": "Standard",
  "ui.modeAutoFit": "Auto-Anpassung (Bild)",
  "ui.shapeNgon": "n-Eck",
  "ui.autofitHeight": "Höhe (mm)",
  "ui.autofitRepeat": "Paneel-Anzahl",
  "ui.autofitSides": "Seiten (n ≧ 3)",
  "ui.uploadShort": "Hochladen",
  "ui.autofitStats": "Umfang: {c} mm · Durchm.: {d} mm · Seite: {w} mm",
  ...
  "license.item3": "Details zum Wechselschicht-Verfahren („振り重ね“ / Interleaved Layering) finden Sie im <a href=\"https://note.com/mithril_mex/n/nf6866893448c\" target=\"_blank\" rel=\"noopener\">note-Artikel</a> des Autors.<br>Unterstützung und Trinkgelder sind willkommen.",
  ...
  "license.item8": "Quellcode verfügbar auf <a href=\"https://github.com/Mithril-3d/BumpMesh_Color\" target=\"_blank\" rel=\"noopener\">GitHub</a>.",
  "imprint.btn": "Datenschutzerklärung",
  "imprint.title": "Datenschutzerklärung",
  "imprint.privacyMeshLocal": "Alle 3D-Modelle (STL, OBJ, 3MF, STEP) und Texturen werden vollständig lokal in Ihrem Browser verarbeitet. Es werden niemals Dateien oder Geometrien auf externe Server übertragen.",
  "imprint.privacyHosting": "Diese Website wird auf <strong>GitHub Pages</strong> (GitHub Inc. / Microsoft Corp., 88 Colin P Kelly Jr St, San Francisco, CA 94107, USA) gehostet. Beim Besuch dieser Seite kann GitHub Ihre IP-Adresse in standardmäßigen Server-Logs verarbeiten. Siehe <a href=\"https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement\" target=\"_blank\" rel=\"noopener\">Datenschutzerklärung von GitHub</a>.",
  "storage.modeLabel": "Autom. Speichern:",
  "storage.session": "Sitzung",
  "storage.local": "Dauerhaft",
  "storage.sessionDesc": "Einstellungen bis zum Schließen des Tabs behalten (sessionStorage)",
  "storage.localDesc": "Einstellungen dauerhaft im Browser speichern (localStorage)",
  "imprint.privacyLocal": "Dieses Tool speichert Benutzereinstellungen (Sprache, Design, Textur-, Mapping- und UI-Optionen) je nach Wahl im <strong>sessionStorage</strong> oder <strong>localStorage</strong> Ihres Browsers. Diese Daten verbleiben vollständig in Ihrem Browser, werden nicht an externe Server übertragen und dienen nicht dem Tracking oder Cookies.",
  ...
  "color.sectionTitle": "Farbe & Multi-Tool",
  "color.enabled": "Aktiviert",
  "color.tabQuantize": "Farbquantisierung",
  "color.tabLayerBlend": "Verschachtelte Schichten",
  "color.show3DPreview": "Farben in 3D-Vorschau anzeigen",
  "color.untexturedTool": "Werkzeug für untexturierte Bereiche",
  "color.untexturedToolTitle": "Werkzeug für maskierte oder nicht texturierte Flächen (z. B. Boden)",
  "color.extruderCount": "Extruder (Farbanzahl)",
  "color.extruderCountTitle": "Anzahl dominanter Farben (Extruder-Anzahl)",
  "color.assignLabel": "Werkzeug:",
  "color.interleavedDesc": "Schichtet jedes Farbwerkzeug abwechselnd auf; erzeugt Erhebungen bei Zielfarbe und Vertiefungen bei Nicht-Zielfarbe.",
  "color.layerThickness": "Schichthöhe (mm)",
  "color.layerThicknessTitle": "Schichthöhe pro Werkzeug (an Slicer-Einstellung anpassen)",
  "color.convexAmp": "Konvex-Versatz (mm)",
  "color.convexAmpTitle": "Überstand für Schichten mit übereinstimmender Farbe",
  "color.concaveAmp": "Konkav-Versatz (mm)",
  "color.concaveAmpTitle": "Einzugstiefe für Schichten, die nicht der Farbe entsprechen",
  "color.profileMode": "Schichtprofil",
  "color.profileModeTitle": "Querschnitt pro Schicht. Flache Stufe ergibt saubere Kanten (Standard / empfohlen).",
  "color.profileStep": "Flache Stufe (Standard / Empfohlen)",
  "color.profileLouver": "45° Lamellen-Überhang (Farbabschirmung / Experimentell)",
  "color.shadingMode": "Schattierungsmodus",
  "color.shadingModeTitle": "Farbverlauf. Scharf erzeugt binäre Werte; Gradient passt die Höhe stufenlos an.",
  "color.shadingSharp": "Scharf (Binär / 0-1)",
  "color.shadingGradient": "Gradient (Kontinuierlich)",
  "color.interleavedTools": "Verschachtelte Werkzeuge",
  "color.interleavedStructure": "🔄 Verschachtelte Schichtstruktur",
  "color.infoPitch": "• Schichthöhe: {pitch} mm (Gesamtschichten: ~{layers})",
  "color.infoConvex": "• Konvex-Versatz: +{val} mm (bei Zielfarbe)",
  "color.infoConcave": "• Konkav-Einzug: -{val} mm (bei Nicht-Zielfarbe)",
  "color.infoProfile": "• Profil: {profile}",
  "color.infoShading": "• Schattierung: {shading}",
  "color.infoPattern": "• Muster: {pattern} → …",
  "color.exportBtn": "🎨 Multi-Tool 3MF exportieren",
  "color.exportBtnTitle": "Vollständig kompatibles Multi-Tool 3MF für PrusaSlicer, OrcaSlicer und Bambu Studio exportieren",
  "color.interleavedPreviewMap": "🖼️ Interleaved-Modulationskarte (2D) anzeigen",
  "color.mapModalTitle": "🖼️ Interleaved-Modulationskarte (Mischgewicht) Vorschau",
  "color.mapModalModeLabel": "Anzeigemodus:",
  "color.mapModalModeCurrent": "① K-Means-Schwerpunkt-Clipping",
  "color.mapModalModeFullrange": "② Tonwerterhaltung (Volle Luminanz / Schattenerhalt)",
  "color.mapModalModeOriginal": "③ Originales Texturbild",
  "color.mapModalGamma": "Tonwert-Gamma:",
  "color.mapModalLegend": "* Weiß (1.0) = Tool 1 max. Erhebung / Schwarz (0.0) = Tool 2 max. Erhebung / Mittelgrau (0.5) = Gleiche Exposition",
  "color.mapModalSavePng": "💾 PNG-Bild speichern",
  "color.mapModalClose": "Schließen",
  "color.mapModalHoverHint": "Bewegen Sie den Mauszeiger über das Bild für Details",
  "color.mapModalLoading": "Palettendaten werden geladen...",
  "color.mapModalNoTexture": "Bitte zuerst ein Texturbild laden.",
};
