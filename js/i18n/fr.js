...
export default {
  ...
  "storage.modeLabel": "Sauvegarde auto :",
  "storage.session": "Session",
  "storage.local": "Persistant",
  "storage.sessionDesc": "Conserver les paramètres jusqu’à la fermeture de l’onglet (sessionStorage)",
  "storage.localDesc": "Conserver les paramètres en permanence dans le navigateur (localStorage)",
  "imprint.privacyLocal": "Cet outil stocke les paramètres utilisateur (langue, thème, texture, mappage et options d’interface) dans le <strong>sessionStorage</strong> ou le <strong>localStorage</strong> de votre navigateur selon votre choix. Ces données restent strictement dans votre navigateur, ne sont jamais transmises à un serveur externe et ne sont pas utilisées pour des cookies ou le suivi.",
  ...
  "color.interleavedPreviewMap": "🖼️ Voir la carte de modulation entrelacée (2D)",
  "color.mapModalTitle": "🖼️ Aperçu de la carte de modulation entrelacée (Poids de mélange)",
  "color.mapModalModeLabel": "Mode d'affichage :",
  "color.mapModalModeCurrent": "① Écrêtage par centroïde K-means",
  "color.mapModalModeFullrange": "② Préservation tonale (Luminance pleine échelle / Ombres préservées)",
  "color.mapModalModeOriginal": "③ Image de texture d'origine",
  "color.mapModalGamma": "Gamma tonal :",
  "color.mapModalLegend": "* Blanc (1.0) = Outil 1 saillie max / Noir (0.0) = Outil 2 saillie max / Gris moyen (0.5) = Exposition égale",
  "color.mapModalSavePng": "💾 Enregistrer l'image PNG",
  "color.mapModalClose": "Fermer",
